...
//go:generate go run github.com/fjl/gencodec -type SetCodeDelegation -field-override setCodeDelegationMarshaling -out gen_setcodedelegation.go
...
type setCodeDelegationMarshaling struct {
	Nonce hexutil.Uint64
}
